        ...
        <div className="container flex flex-col-reverse md:flex-row items-center gap-8 md:gap-12 lg:gap-24">
          <div className="flex flex-col items-center md:items-start text-center md:text-right space-y-6 flex-1">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight animate-fade-in">
              <span className="text-gradient">ایده‌ساز</span> <br />
              دستیار هوشمند تولید محتوا
            </h1>
            <p
              className="text-xl text-muted-foreground max-w-[600px] animate-fade-in"
              style={{ animationDelay: "150ms" }}
            >
              با کمک هوش مصنوعی، ایده‌های خلاقانه تولید کنید، محتوا را زمانبندی
              کنید و عملکرد آن را تحلیل کنید.
            </p>
            <div
          ...
          <div
            className="flex-1 glass-effect p-4 rounded-xl animate-fade-in"
            style={{ animationDelay: "200ms" }}
          >
            <div className="rounded-md overflow-hidden aspect-video">
              <img
                src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&q=80"
                alt="ایده‌ساز - دستیار هوشمند محتوا"
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg max-w-[700px] mx-auto">
              هوش مصنوعی که به شما در تمام مراحل تولید و انتشار محتوای جذاب کمک
              می‌کند
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-background rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground">
                با تحلیل روندهای برتر و محتواهای موفق قبلی شما، ایده‌های جذاب
                برای محتوای جدید پیشنهاد می‌دهد.
              </p>
            </div>
            ...
            <div className="bg-background rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground">
                محتوای شما را در بهترین زمان‌ها زمانبندی و منتشر می‌کند تا
                بیشترین تعامل را داشته باشید.
              </p>
            </div>
            ...
            <div className="bg-background rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground">
                نظرات و بازخوردهای مخاطبان را تحلیل و دسته‌بندی می‌کند تا از
                عملکرد محتوای خود آگاه شوید.
              </p>
            </div>
            ...
            <div className="bg-background rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground">
                برای انواع محتوا از متن و تصویر گرفته تا ویدئو و پادکست،
                پیشنهادات متناسب ارائه می‌دهد.
              </p>
            </div>
            ...
            <div className="bg-background rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground">
                عملکرد محتوای شما را در قالب نمودارها و آمارهای دقیق و قابل فهم
                نمایش می‌دهد.
              </p>
            </div>
            ...
            <div className="bg-background rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground">
                منابع مرتبط و معتبر برای تقویت محتوای شما و افزایش اعتبار آن
                پیشنهاد می‌دهد.
              </p>
            </div>
          </div>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              آماده برای متحول کردن استراتژی محتوای خود هستید؟
            </h2>
